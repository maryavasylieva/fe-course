...
//   Создайте функцию isLoginUnique(allLogins, login), которая принимает логин(includes) и список 
...
addLogin(logins, 'Marusya');
addLogin(logins, 'MarusyaRazDwaTriKalina');
addLogin(logins, 'AntonOlegovich');
...
// const isLoginValid = function(users) {
...
//   if (users.length >= 4 && users.length <= 16){
//     alert('Пароль от 4 до 16 символов');
//     return users;
//   }
...
// const isLoginUnique = function(allLogins) {
//   if(allLogins.includes()){
//     return users;
//   }
...
// const addLogin = function(allLogins) {

//   if(isLoginValid !== logins){
...
//   do{
//     users = prompt('Введите ваш логин, длина от 4 до 16 символов')
//   }while(logins.includes(users))
