...
const Notepad = function Notepad(notes = []) {
  // Перенеси свойства и методы объекта notepad в конструкто
  this.notes = notes;
    ...
    this.findNoteById = function (id) {
      ...
      //  */
      return this.notes.find(key => key.id === id)
    ...
    this.filterNotesByQuery = function (query) {
      ...
      for (let i = 0; i < this.notes.length; i++) {
        ...
        const bodyToLowertCase = this.notes[i].body.toLowerCase();
